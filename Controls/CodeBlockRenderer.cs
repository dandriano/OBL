...
{
    public class CodeBlockRenderer : AttributedTextObjectRenderer<CodeBlock>
    {
        protected override void Write(AttributedTextRenderer renderer, CodeBlock codeBlock)
        {
