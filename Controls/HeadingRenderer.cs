...
{
    public class HeadingRenderer : AttributedTextObjectRenderer<HeadingBlock>
    {
        protected override void Write(AttributedTextRenderer renderer, HeadingBlock block)
        {
